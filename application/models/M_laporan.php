...
class M_laporan extends CI_Model 
{
    public function laporan_harian($tanggal, $bulan, $tahun)
    {
        ...
        $this->db->join('tbl_detail_transaksi', 'tbl_transaksi.no_order = tbl_detail_transaksi.no_order', 'left');
        $this->db->join('tbl_produk', 'tbl_detail_transaksi.id_produk = tbl_produk.id_produk', 'left');
        ...
        $this->db->order_by('tbl_transaksi.no_order'); // Menambahkan sorting berdasarkan nomor order
        $query = $this->db->get();
