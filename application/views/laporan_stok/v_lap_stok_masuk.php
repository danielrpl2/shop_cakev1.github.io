<div class="container-fluid">
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="text-center">Laporan Stok Masuk</h4><br>
...
<script type="text/javascript">
    function printTable() {
        ...
        document.body.innerHTML = '<h4 class="text-center">Laporan Stok Masuk</h4><br>' + document.getElementById("example1").outerHTML;
    ...
    function exportToExcel() {
        ...
        /* Create a worksheet */
        var ws = XLSX.utils.aoa_to_sheet([["No", "Nama Produk", "Qty", "Tanggal", "Nama Supplier"], ...rows]);

        /* Create a workbook */
        var wb = XLSX.utils.book_new();
        XLSX.utils.book_append_sheet(wb, ws, "Laporan Stok Masuk - " + currentDate);

        /* Save the workbook to a file */
        XLSX.writeFile(wb, "laporan_stok_masuk_" + currentDate + ".xlsx");
    }
    ...
    function exportToPdf() {
        ...
        html2pdf(element, {
            margin: 10,
            filename: 'Laporan_Stok_Masuk_' + currentDate + '.pdf',
