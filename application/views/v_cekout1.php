...
class Rajaongkir extends CI_Controller 
{
    ...
    public function provinsi(){
		...
		if ($err) {
			...
			foreach ($data_provinsi as $key => $provinsi) {
				echo "<option value='" . $provinsi['province_id'] . "' id_provinsi= '" . $provinsi['province_id'] . "'>" . $provinsi['province'] . "</option>";
			}
		}
	}

	//Function Data Kota sesuai Api
    ...
    public function paket()
    {
        ...
        CURLOPT_POSTFIELDS => "origin=" . $id_kota_asal . "&destination=" .  $id_kota . "&weight=" . $berat . "&courier=" . $exspedisi,
        CURLOPT_HTTPHEADER => array(
