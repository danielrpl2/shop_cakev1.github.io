    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navigation">
        <ul class="navbar-nav mx-auto">
          ...
          <!-- <li class="nav-item">
            <a class="nav-link me-2" href="<?= base_url('home') ?>">
        ...
        <div class="col-xl-4 col-lg-5 col-md-7 mx-auto">
          <div class="card z-index-0">
            ...
            <div class="row px-xl-5 px-sm-4 px-3">
              ...
              <div class="mt-2 position-relative text-center">
                <p class="text-sm font-weight-bold mb-2 text-secondary text-border d-inline z-index-2 bg-white px-3">
                 <a href="<?= base_url('home') ?>"><i class="fa fa-arrow-right" aria-hidden="true"></i> Back To Home <i class="fa fa-arrow-left" aria-hidden="true"></i></a>
                </p>
              </div>
            </div>
            <div class="card-body">
            <?php 
              ...
              <div class="mb-3">
                  <input type="text" class="form-control" placeholder="Username : admin" name="username" aria-label="Username">
                </div>
                <div class="mb-3">
