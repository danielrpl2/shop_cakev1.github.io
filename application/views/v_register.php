...
<body>
     ...
     <div class="container">
        <div class="form register">
            ...
            <div class="inputBox">
                <input type="password" name="ulangi_password" value="<?= set_value('ulangi_password') ?>" required>
                <i class="fa-solid fa-lock"></i>
            ...
            <div class="go-home-register">
                <a href="<?= base_url('pelanggan/login') ?>" class="register-link">Sudah Punya Akun? Login</a>
...
.container .form .alert {
    ...
    font-weight: 500;
    border-radius: 10px;
    margin-bottom: 15px; /* Menambahkan jarak antara notifikasi */
    box-shadow: -5px -5px 15px rgba(225, 225, 225, 0.1),
        5px 5px 15px rgba(0, 0, 0, 0.35);
}
