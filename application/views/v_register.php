          ...
          <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navigation">
              <ul class="navbar-nav mx-auto">
                ...
                <li class="nav-item">
                  <a class="nav-link me-2" href="<?= base_url ('pelanggan/register') ?>">
                    <i class="fas fa-user-circle opacity-6 text-dark me-1"></i>
                    Register
                  </a>
                </li>
                <li class="nav-item">
                  <a class="nav-link me-2" href="<?= base_url ('pelanggan/login') ?>">
            ...
            <div class="col-xl-4 col-lg-5 col-md-7 d-flex flex-column mx-lg-0 mx-auto">
              <div class="card card-plain">
                <div class="card-header pb-1 text-start">
                  <h4 class="font-weight-bolder">Register Pelanggan</h4>
                </div>
                <div class="card-body">
                 <?php 
                   ...
                   echo form_open('pelanggan/register'); ?>
                    <div class="mb-3">
                      <input type="text" name="nama_pelanggan" value="<?= set_value('nama_pelanggan') ?>" class="form-control form-control-lg" placeholder="Your Name.." aria-label="Your Name..">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                      <input type="password" name="ulangi_password" value="<?= set_value('ulangi_password') ?>" class="form-control form-control-lg" placeholder="Confirm password.." aria-label="Confirm password..">
                    </div>
                ...
                <div class="card-footer text-center pt-0 px-lg-2 px-1">
                  ...
                  Already have an account?
                    <a href="<?= base_url('pelanggan/login') ?>" class="text-primary text-gradient font-weight-bold">Login</a>
                  </p>
                </div>
              </div>
            </div>
